  ...
  class RegistrationsController < Devise::RegistrationsController
    ...
    def handle_profile_update
      ...
      if resource.update(profile_update_params)
        ...
        redirect_to defined?(user_profile_path) ? user_profile_path(resource) : root_path
      else
    ...
    def handle_account_update
      ...
      if account_update_params[:current_password].present? && resource.valid_password?(account_update_params[:current_password])
        ...
        Rails.logger.debug "Current password is invalid or not provided."
